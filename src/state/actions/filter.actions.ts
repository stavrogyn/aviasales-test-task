...
const checkTransfersAmountFilter = (transferNumber: number) => ({ type: FILTERS_TRANSFERS_AMOUNT_DID_CHECK, transferNumber });
const uncheckTransfersAmountFilter = (transferNumber: number) => ({ type: FILTERS_TRANSFERS_AMOUNT_DID_UNCHECK, transferNumber });
...
const changeTotalAmountOfTransfersAmountFilter = (newTransfers: TransfersAmountInterface) => ({ type: FILTERS_TOTAL_TRANSFERS_AMOUNT_WAS_CHANGED, newTransfers });

...
const processResultsResponse = (tickets: any) => ({ type: RESULT_RESPONSE_WAS_RECIEVED, tickets });
const rerenderTickets = (tickets: any) => ({ type: RERENDER_DISPLAYED_TICKETS, tickets });
